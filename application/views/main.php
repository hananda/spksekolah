            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.html" class="site_title" style="font-size:18px !important"><i class="fa fa-paw"></i> <span>Admin - SPK Sekolah</span></a>
                    </div>
                ...
                <footer>
                    <div class="">
                        <p class="pull-right"><a></a>
                            <span class="lead"> <i class="fa fa-paw"></i> SPK Sekolah</span>
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </footer>
