...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left" data-parsley-validate="" id="formkriteria" novalidate="">
                    <input type="hidden" name="idkriteria" id="idkriteria" />
                    <div class="form-group">
                        <label for="namakriteria" class="control-label col-md-3 col-sm-3 col-xs-12">Nama Kriteria
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12" required="required" name="namakriteria" id="namakriteria" data-parsley-id="5637"><ul class="parsley-errors-list" id="parsley-id-5637"></ul>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#formkriteria").submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>kriteria/index/update',
                type: 'POST',
                dataType: 'json',
                data: data,
            })
        ...
        var table = $('#tabelkriteria').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: "<?php echo base_url(); ?>kriteria/index/get",
            type: "POST",
            data: function (d) {
        ...
        function initEvent() {
            $(".btndelete").click(function (e) {
                ...
                var id = dataedit[0];
                if (sure) {
                    $.post("<?php echo base_url(); ?>kriteria/index/delete", {'idkriteria': id}, function (response) {
                        if(response.status){
                            NotifikasiToast({
                                type : 'success', // ini tipe notifikasi success,warning,info,error
                                msg : response.message, //ini isi pesan
